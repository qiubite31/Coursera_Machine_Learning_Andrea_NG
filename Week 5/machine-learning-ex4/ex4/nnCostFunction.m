...
c = (1/m) * sum(sum(-yMatrix.*log(a3) - (1-yMatrix).*log(1-a3)))
...
for i = 1:m
  a1 = X(i,1:end) 
  z2 = [ones(1,1), a1] * Theta1'
  a2 = sigmoid(z2)
  z3 = [ones(1,1), a2] * Theta2'
  a3 = sigmoid(z3)'
  
  delta3 = a3 - yMatrix(i,1:end)'
  delta2 = (Theta2' * delta3) .* [1;sigmoidGradient(z2)']
  delta2 = delta2(2:end)
  
  Theta1_grad = Theta1_grad + (delta2 * [ones(1,1), a1])
  Theta2_grad = Theta2_grad + (delta3 * [ones(1,1), a2])
